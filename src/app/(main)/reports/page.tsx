      ...
      <div className="hidden print:block border-b-2 border-emerald-800 pb-4 mb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right text-xs">
            <div><strong>รอบรายงาน:</strong> {periodLabel}</div>
            <div><strong>พิมพ์เมื่อ:</strong> {formatDateTime(new Date().toISOString(), lang)}</div>
            <div><strong>ผู้ออกรายงาน:</strong> {currentUser.full_name} ({currentUser.role.toUpperCase()})</div>
          </div>
        </div>
      </div>
